...
| Source provisioning | `provision-source` (secrets)      | source_runtime fields=runtime_provisioner, catalog_var_name, bronze_schema_name, volume_name, volume_type, volume_path_var_name, bucket_provider_examples, volume_secret_scope_var_name, volume_secret_scope_default, volume_secret_key_var_name, volume_secret_key_default, secret_blob_format, sample_artefact_path, terraform_required_version | src/connectors/trufflehog/runtime/, mkdocs/docs/connectors/secrets/trufflehog.md §Source provisioning | 2026-04-25 | 05db254 (split-source-and-databricks-skills) |
| Module generation  | `generate-connector` (secrets)     | page hash=98b2b80f6f2c; databricks_runtime fields=secret_scope, bronze_schema, bronze_tables, envelope_table, cron_schedule, uc_catalog_var, job_name, default_target, default_catalog, secret_env_vars, optional_aws_credentials_secret, tool_source_label, entry_wrappers, cli_artefact_prefixes | src/connectors/trufflehog/__init__.py, src/connectors/trufflehog/config.yml, src/connectors/trufflehog/ingest.py, src/connectors/trufflehog/transform.py, src/connectors/trufflehog/mapping.yml, src/connectors/trufflehog/severity.yml, src/connectors/trufflehog/status.yml, src/connectors/trufflehog/tests/, src/connectors/trufflehog/scripts/install.sh, src/connectors/trufflehog/scripts/load-secrets.sh, src/connectors/trufflehog/sql/artefact_envelope.sql, src/connectors/trufflehog/resources/job.yml, src/connectors/trufflehog/resources/schemas.yml, mkdocs/docs/connectors/secrets/trufflehog.md §4–§7 | 2026-04-25 | 05db254 (split-source-and-databricks-skills) |

...
| Source provisioning | `provision-source` (sast)         | source_runtime fields=runtime_provisioner, terraform_required_version, aws_region_var_name, eks_cluster_name_var_name, project_prefix_default, namespace_default, eks_oidc_provider_arn_var_name, artifact_bucket_var_name, cron_schedule_default, scanner_image_default, repo_urls_default, scan_script_path, irsa_s3_actions, irsa_service_account_name, env_secret_keys, clone_token_var_name | src/connectors/semgrep/runtime/, mkdocs/docs/connectors/sast/semgrep.md §Source provisioning | 2026-04-25 | b230852 (split-source-and-databricks-skills) |
| Module generation | `generate-connector` (sast) | page hash=cf446aa88297; databricks_runtime fields=deployment_style, secret_scope, bronze_schema, bronze_tables, cron_schedule, uc_catalog_var, job_name, default_target, default_catalog, secret_env_vars, tool_source_label, entry_wrappers, bronze_volume, bronze_volume_storage_location, cli_artefact_prefixes, extra_install_env_vars | src/connectors/semgrep/__init__.py, src/connectors/semgrep/config.yml, src/connectors/semgrep/ingest.py, src/connectors/semgrep/transform.py, src/connectors/semgrep/mapping.yml, src/connectors/semgrep/severity.yml, src/connectors/semgrep/status.yml, src/connectors/semgrep/tests/, src/connectors/semgrep/scripts/install.sh, src/connectors/semgrep/scripts/load-secrets.sh, src/connectors/semgrep/install.sh, src/connectors/semgrep/resources/job.yml, src/connectors/semgrep/resources/schemas.yml, src/connectors/semgrep/resources/volumes.yml, mkdocs/docs/connectors/sast/semgrep.md §4–§7 | 2026-04-25 | b230852 (split-source-and-databricks-skills) |

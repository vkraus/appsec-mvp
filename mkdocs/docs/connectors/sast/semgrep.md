...
| Module generation  | `generate-connector` (sast)        | page hash=72c0eb36b9f8                                           | src/connectors/semgrep/, tests/connectors/semgrep/, config/severity/semgrep.yml, config/status/semgrep.yml, resources/semgrep-job.yml | 2026-04-25 | 783dbc1 (retrofit-9-connectors)  |
| Validation         | `validate-implementation` (sast)   | module path=src/connectors/semgrep/                                   | mkdocs/docs/connectors/sast/semgrep.md §5                                          | 2026-04-25 | 26a3f61 (retrofit-9-connectors)          |

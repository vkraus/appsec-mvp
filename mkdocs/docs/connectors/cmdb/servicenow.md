...
| Module generation | `generate-connector` (cmdb) | page hash=c260b4bb52cc | src/connectors/servicenow/{config.yml,ingest.py,transform.py,mapping.yml,severity.yml,status.yml}, src/connectors/servicenow/tests/, src/connectors/servicenow/scripts/{load-secrets.sh,install.sh}, src/connectors/servicenow/install.sh, src/connectors/servicenow/resources/{job.yml,schemas.yml,connection.yml,pipeline.yml}, src/connectors/servicenow/sql/business_applications_envelope.sql | 2026-04-25 | 05db254 (split-source-and-databricks-skills) |

...
| Module generation  | `generate-connector` (scm)         | page hash=e8f011616c52                                                | src/connectors/gitlab/, src/connectors/gitlab/tests/, src/connectors/gitlab/severity.yml, src/connectors/gitlab/status.yml, src/connectors/gitlab/resources/job.yml, src/connectors/gitlab/ingest_entry.py, src/connectors/gitlab/transform_entry.py | 2026-04-25 | 615e721 (split-source-and-databricks-skills) |

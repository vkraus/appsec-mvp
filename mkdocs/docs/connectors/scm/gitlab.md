...
| Source provisioning | `provision-source` (scm)          | source_runtime fields=runtime_provisioner, tenant_host, target_namespace_id, token_secret_scope, token_secret_key, bronze_schema_name, catalog_var_name, terraform_required_version | src/connectors/gitlab/runtime/, mkdocs/docs/connectors/scm/gitlab.md §Source provisioning | 2026-04-25 | 05db254 (split-source-and-databricks-skills) |
| Module generation  | `generate-connector` (scm)         | page hash=2ce37511948d; databricks_runtime fields=secret_scope, bronze_schema, bronze_tables, cron_schedule, uc_catalog_var, job_name, default_target, default_catalog, secret_env_vars, extra_install_env_vars, tool_source_label, entry_wrappers | src/connectors/gitlab/__init__.py, src/connectors/gitlab/config.yml, src/connectors/gitlab/ingest.py, src/connectors/gitlab/transform.py, src/connectors/gitlab/mapping.yml, src/connectors/gitlab/severity.yml, src/connectors/gitlab/status.yml, src/connectors/gitlab/tests/, src/connectors/gitlab/scripts/install.sh, src/connectors/gitlab/scripts/load-secrets.sh, src/connectors/gitlab/ingest_entry.py, src/connectors/gitlab/transform_entry.py, src/connectors/gitlab/resources/job.yml, src/connectors/gitlab/resources/schemas.yml, mkdocs/docs/connectors/scm/gitlab.md §4–§7 | 2026-04-25 | 05db254 (split-source-and-databricks-skills) |

"""Verify owasp_zap.ingest and owasp_zap.transform expose the section 2.4.1 contract."""
...
def test_ingest_wrapper_has_contract_signature() -> None:
    from src.connectors.owasp_zap import ingest as mod
...
def test_transform_wrapper_has_contract_signature() -> None:
    from src.connectors.owasp_zap import transform as mod

...
# Minimal state skeleton. Real HWM lookup from the control table will be
# wired when the framework HWM loader lands (see common.state). The
# ingest contract accepts extra={"token", "org"} populated from secrets.
state = {
    "source": source_name,
